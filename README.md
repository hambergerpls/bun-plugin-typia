...
|---|---|---|---|
| 2.x | 13.1.19 to 15.x | 7.x | Supported |
| 1.x | 5.5.4 to 11.x | 5.x | No longer supported |

typia 12 to 13.1.1 are not supported by any version.
...
1. Update the packages: `bun add typia@15` (or typia 13.1.19 or later) and `bun add -d bun-plugin-typia@2 typescript@7`.
